...
public class EditFrm extends javax.swing.JDialog {
    ...
    public EditFrm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setTitle("Cap nhat thong tin");
    ...
    private void initComponents() {
        ...
        jLabel7.setText("SỬA THÔNG TIN HỌC SINH");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "Điểm phải là một số, ID không được trùng!");
            isOK = false;
        }
        if(isOK) {
            Student s = new Student(MaHs, TenHS, Diem, HinhAnh, DiaChi, GhiChu);
            if(home.updateStudent(s)) {
    ...
    public void setEditData(Student s) {
        txtID.setText(s.getMHS());
        txtID.setEditable(false);
        txtName.setText(s.getTenHS());
        txtAddress.setText(s.getDiaChi());
        txtMark.setText(s.getDiem() + "");
        txtImg.setText(s.getHinhAnh());
